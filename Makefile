...
# j5t.io/hsm-secrets-operator-bundle:$VERSION and j5t.io/hsm-secrets-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= j5t.io/hsm-secrets-operator
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	CGO_ENABLED=0 $(CONTROLLER_GEN) rbac:roleName=manager-role crd webhook paths="./..." output:crd:artifacts:config=config/crd/bases
...
KIND_CLUSTER ?= hsm-secrets-operator-test-e2e
...
.PHONY: quality
quality: fmt vet lint ## Run full code quality check (format, vet, lint)
